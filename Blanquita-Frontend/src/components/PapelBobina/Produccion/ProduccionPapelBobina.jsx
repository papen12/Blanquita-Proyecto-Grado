...
function CardActiva({ p, onInsertar, onPausar, onFinalizar }) {
  return (
    <div className="flex flex-col gap-3.5 rounded-2xl border-2 border-slate-200 bg-white p-5 shadow-sm">
      ...
      <div className="flex flex-col gap-2 sm:flex-row">
        <Button
          onClick={onInsertar}
          className="h-10 flex-1 gap-1.5 bg-gradient-to-r from-c3 to-c4 font-bold hover:opacity-90"
        >
        ...
        <Button
          onClick={onPausar}
          variant="outline"
          className="h-10 flex-1 gap-1.5 border-amber-300 font-bold text-amber-600 hover:bg-amber-50"
        >
          <Pause size={15} strokeWidth={2.75} />
          Pausar
        </Button>
        <Button
          onClick={onFinalizar}
          variant="outline"
          className="h-10 flex-1 gap-1.5 border-emerald-300 font-bold text-emerald-600 hover:bg-emerald-50"
        >
    ...
    <div className="flex flex-col gap-3.5 rounded-2xl border-2 border-amber-200 bg-white p-5 shadow-sm">
      ...
      <div className="flex flex-col gap-2 sm:flex-row">
        ...
        <Button
          ...
          disabled={procesando}
          variant="outline"
          className="h-10 flex-1 gap-1.5 border-c3/30 font-bold text-c3 hover:bg-c4/8"
        >
          {procesando ? (
        ...
        <Button
          onClick={onCancelar}
          variant="outline"
          className="h-10 flex-1 gap-1.5 border-red-300 font-bold text-red-600 hover:bg-red-50"
        >
